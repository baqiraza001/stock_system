        ...
        <div class="col-md-4 col-sm-5 col-xs-12 col-lg-3">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h4 class="panel-title text-center"><i class="fa fa-edit"></i> Edit User</h4>
                    <form method="post" enctype="multipart/form-data" action="<?php echo current_url();?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control"
                             placeholder="Enter Password" value="<?php echo set_value('password'); ?>" minlength="8" maxlength="50" />
                        </div>
                        <div class="form-group">
