        ...
        <div class="col-md-10 col-sm-10 col-xs-12 col-lg-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h4 class=" text-center"><i class="fa fa-plus"></i> Add Item</h4>
                    <form method="post" enctype="multipart/form-data" action="<?php echo current_url();?>">
                        ...
                        <div class="form-group">
                            ...
                            value="<?php echo set_value('current_stock') ?>" />
                        </div>
                        <div class="form-group">
                            ...
                            value="<?php echo set_value('threshold') ?>" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control descripton-text" name="item_notes" placeholder="Enter Notes"><?php echo set_value('item_notes'); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="desc">Description:</label>
                            <textarea class="form-control descripton-text" name="item_description" placeholder="Enter description"><?php echo set_value('item_description'); ?></textarea>
                        </div>
...
<script type="text/javascript">
        $('select[name = "location_id"]').val(<?php echo set_value('location_id'); ?>);
        $('select[name = "category_id"]').val(<?php echo set_value('category_id'); ?>);
        $('select[name = "supplier_id"]').val(<?php echo set_value('supplier_id'); ?>);
</script>