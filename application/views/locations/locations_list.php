        ...
        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 class=" text-center bg-info">Locations</h3>
                    <?php echo $this->session->flashdata('alert');?>
                    <div class="text-right" ><a href="<?php echo site_url('locations/add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Location</a></div><br>
    ...
    <!-- Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><i class="fa fa-exclamation-circle fa-lg" style="color: red"></i> Do you really want to delete this location?</p>
            </div>
